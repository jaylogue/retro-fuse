...
int retrofuse_initfs(const struct retrofuse_config * cfg)
{
    ...
    res = bsd29fs_mkfs(cfg->fssize, cfg->initfsparams.isize, &flparams);
    if (res != 0) {
